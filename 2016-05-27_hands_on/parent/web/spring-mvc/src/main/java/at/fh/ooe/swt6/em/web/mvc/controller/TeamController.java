...
public class TeamController implements Serializable {
    ...
    public ModelAndView index() {
        ...
        sessionHelper.setAttribute(SessionHelper.SessionConstants.TEAMS_SESSION.name, new TeamSessionModel());
    ...
    public ModelAndView backFromForm() {
        ...
        sessionHelper.getAttribute(SessionHelper.SessionConstants.TEAMS_SESSION.name, TeamSessionModel.class).clear();
    ...
    public ModelAndView newTeam() {
        final TeamSessionModel sessionModel = sessionHelper.getAttribute(SessionHelper.SessionConstants.TEAMS_SESSION.name,
